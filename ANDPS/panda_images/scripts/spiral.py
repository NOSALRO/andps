...
# box
spiral_box_packages = [("spiral_box", "urdfs/spiral_box")]
spiral_box = rd.Robot("urdfs/spiral_box/spiral_box.urdf",  spiral_box_packages,"spiral_box")
spiral_box.set_color_mode("material")
spiral_box.fix_to_world()
box_tf = spiral_box.base_pose()
box_tf.set_translation([3.5, 0., 1.])
spiral_box.set_base_pose(box_tf)
simu.add_robot(spiral_box)
...
np.savez('data/spiral.npz', eef_x =eef_x, eef_vx=eef_vx, images = images[:,:,1:])
